...
import MovieRatings from "../../DetailMovies/MovieRating";
import { MoviesContext } from "../../../config/app_config";
import { motion } from "framer-motion";
import { dataMovie } from "../../../config/config";
import styles from './Movies.module.css'

import {IoIosArrowDown, IoIosArrowUp, IoIosTrash, IoMdClose} from "react-icons/io";


export const MoviesFav = ({list}) => {
